...
public class Robot extends TimedRobot {
  ...
  Command AutoCrossLineCommand;

  //public static boolean conveyorToggleCount;
  //public static boolean intakeToggleBool;
  ...
  public void robotInit() {
    ...
    //AutoCrossLineCommand = new AutoCrossLine();
    conveyor = new Conveyor();
    intake = new Intake();
    climber = new Climber();
    autoTimer = new Timer();

    //conveyorToggleCount = false;
  ...
  public void autonomousPeriodic() {
    ...
    if (autoTimer.get() < 3){
      conveyor.toggleConveyor(true);
    }else if(autoTimer.get() < 6.5){
      conveyor.toggleConveyor(false);
